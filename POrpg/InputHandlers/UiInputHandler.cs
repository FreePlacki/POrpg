...
public class UiInputHandler : InputHandler
{
    public override ICommand HandleInput(ConsoleView view, Dungeon.Dungeon dungeon, ConsoleKeyInfo keyInfo)
    {
        return keyInfo.Key switch
        {
            ...
            _ when keyInfo.KeyChar == ']' => new QuitCommand(view),
            _ when keyInfo.KeyChar == '?' => new ShowInstructionsCommand(),
            ConsoleKey.L => new SelectItemCommand(view, dungeon, new EquipmentSlot(EquipmentSlotType.LeftHand)),
            ConsoleKey.R => new SelectItemCommand(view, dungeon, new EquipmentSlot(EquipmentSlotType.RightHand)),
            ConsoleKey.B => new MoveToBackpackCommand(view, dungeon),
            ConsoleKey.D1 or ConsoleKey.D2 or ConsoleKey.D3 or ConsoleKey.D4 or ConsoleKey.D5 or ConsoleKey.D6
                ...
                new SelectItemCommand(view, dungeon, new BackpackSlot(slot - 1)),
