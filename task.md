...
- [x] skittish opponent: When the player is near him, he tries to escape from him, moving away from his current position.

- [x] Adding new behaviors, as well as changing the behavior of the opponent during the program should be easy (e.g. when the opponent's health reaches a low level, he may start to run away from the player)
